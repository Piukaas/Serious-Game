...
public class DetailPageManager : MonoBehaviour
{
    ...
    void Start()
    {
        if (PlayerPrefs.GetString("Character") == "Floor")
        {
            ...
            ageText.text = "Leeftijd: 61 jaar";
            jobText.text = "Beroep: Chef kok";
        ...
        {
            titleText.text = "Mark";
            ageText.text = "Leeftijd: 45 jaar";
            jobText.text = "Beroep: Docent";
        ...
        {
            titleText.text = "Emma";
            ageText.text = "Leeftijd: 60 jaar";
            jobText.text = "Beroep: Advocate";
        ...
        {
            titleText.text = "Finn";
            ageText.text = "Leeftijd: 68 jaar";
            jobText.text = "Beroep: Ingenieur";
